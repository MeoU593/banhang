...
public class LogisticsReportsPermissionConfigManager : IPermissionConfigManager
{
    ...
    public IList<PermissionConfig> AllConfigs => new List<PermissionConfig>
    {
        ...
        new("Admin area. Logistics reports. Input own unit reports", InputOwnUnitReports, nameof(StandardPermission.System), NopCustomerDefaults.AdministratorsRoleName, NopCustomerDefaults.VendorsRoleName),
        new("Admin area. Logistics reports. View own unit reports", ViewOwnUnitReports, nameof(StandardPermission.System), NopCustomerDefaults.AdministratorsRoleName, NopCustomerDefaults.VendorsRoleName),
        new("Admin area. Logistics reports. View child unit reports", ViewChildUnitReports, nameof(StandardPermission.System), NopCustomerDefaults.AdministratorsRoleName, NopCustomerDefaults.VendorsRoleName),
        new("Admin area. Logistics reports. Submit own unit reports", SubmitOwnUnitReports, nameof(StandardPermission.System), NopCustomerDefaults.AdministratorsRoleName, NopCustomerDefaults.VendorsRoleName),
        new("Admin area. Logistics reports. Return child unit reports", ReturnChildUnitReports, nameof(StandardPermission.System), NopCustomerDefaults.AdministratorsRoleName, NopCustomerDefaults.VendorsRoleName),
