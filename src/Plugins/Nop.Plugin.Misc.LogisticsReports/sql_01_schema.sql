-- SQL Server schema script for Nop.Plugin.Misc.LogisticsReports MVP 1
-- Generated from FluentMigrator schema for environments where DB review is needed before install.
...
CREATE TABLE [dbo].[LR_OrganizationUnit](
    ...
    [DisplayOrder] INT NOT NULL CONSTRAINT [DF_LR_OrganizationUnit_DisplayOrder] DEFAULT(0),
    [IsActive] BIT NOT NULL CONSTRAINT [DF_LR_OrganizationUnit_IsActive] DEFAULT(1),
...
CREATE TABLE [dbo].[LR_CustomerOrganizationUnit](
    ...
    [IsPrimary] BIT NOT NULL CONSTRAINT [DF_LR_CustomerOrganizationUnit_IsPrimary] DEFAULT(0),
    [CanInputReport] BIT NOT NULL CONSTRAINT [DF_LR_CustomerOrganizationUnit_CanInputReport] DEFAULT(0),
    [CanReviewChildReports] BIT NOT NULL CONSTRAINT [DF_LR_CustomerOrganizationUnit_CanReviewChildReports] DEFAULT(0),
    [CanSubmitReport] BIT NOT NULL CONSTRAINT [DF_LR_CustomerOrganizationUnit_CanSubmitReport] DEFAULT(0),
    [CanLockReport] BIT NOT NULL CONSTRAINT [DF_LR_CustomerOrganizationUnit_CanLockReport] DEFAULT(0)
);
...
CREATE TABLE [dbo].[LR_ReportTemplate](
    ...
    [IsActive] BIT NOT NULL CONSTRAINT [DF_LR_ReportTemplate_IsActive] DEFAULT(1),
...
CREATE TABLE [dbo].[LR_ReportIndicator](
    ...
    [DisplayOrder] INT NOT NULL CONSTRAINT [DF_LR_ReportIndicator_DisplayOrder] DEFAULT(0),
    ...
    [IsRequired] BIT NOT NULL CONSTRAINT [DF_LR_ReportIndicator_IsRequired] DEFAULT(0),
    [IsActive] BIT NOT NULL CONSTRAINT [DF_LR_ReportIndicator_IsActive] DEFAULT(1)
);
...
CREATE TABLE [dbo].[LR_ReportPeriod](
    ...
    [IsLocked] BIT NOT NULL CONSTRAINT [DF_LR_ReportPeriod_IsLocked] DEFAULT(0),
    [CreatedOnUtc] DATETIME2 NOT NULL
);
...
CREATE TABLE [dbo].[LR_UnitReport](
    ...
    [StatusId] INT NOT NULL,
    [CurrentVersion] INT NOT NULL CONSTRAINT [DF_LR_UnitReport_CurrentVersion] DEFAULT(1),
...
CREATE TABLE [dbo].[LR_UnitReportValue](
    ...
    [SourceTypeId] INT NOT NULL CONSTRAINT [DF_LR_UnitReportValue_SourceTypeId] DEFAULT(0),
...
CREATE TABLE [dbo].[LR_UnitReportImportHistory](
    ...
    [SuccessCount] INT NOT NULL CONSTRAINT [DF_LR_UnitReportImportHistory_SuccessCount] DEFAULT(0),
    [ErrorCount] INT NOT NULL CONSTRAINT [DF_LR_UnitReportImportHistory_ErrorCount] DEFAULT(0),
