...
public class NewsInstallService
{
    ...
    private async Task InsertLocalesAsync()
    {
        await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ...
            ["Plugins.Misc.News.ArtificialIntelligence.NewsItemFullRequired"] = "News item full (on {0} language) is required for meta tags generation with artificial intelligence services.",
            ["Plugins.Misc.News.ArtificialIntelligence.NewsItemTitleRequired"] = "News item title (on {0} language) is required for meta tags generation with artificial intelligence services.",
